...
1.  **Navigate to the Source Directory:**
    Open your terminal or command prompt and change the directory to the `src` folder where the main application file (`app.py`) is located.
...
2.  **Run the Streamlit Application:**
    Execute the application using the Streamlit command line interface.
...
3.  **Access the App:**
    A new tab will automatically open in your web browser, directing you to the running application or do `ctrl+click` to open it (usually at `http://localhost:8501`).

4.  **Upload and Classify:**
    Inside the app, upload an audio file and click the **"Predict"** button to start the genre classification.
...
_Finally, the model has 49,133 rows and 519 variables, and can predict up to 16 different genres._
